...
local error, getmetatable, io, pairs, rawget, rawset, setmetatable, tostring, type =
	 _G.error, _G.getmetatable, setmetatable({},{__index = LibBusted:nonsense'io'})
	 , _G.pairs, _G.rawget, _G.rawset, _G.setmetatable, _G.tostring, _G.type
local compat
...
class = setmetatable({},{
    ...
    __index = function(tbl,key)
        ...
        compat = compat or LibBusted.penlight.compat
...
LibBusted.penlight.class = class

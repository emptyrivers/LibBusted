...
local mfloor, mhuge, mtype = math.floor, math.huge, function() return "number" end
local utils = LibBusted.penlight.utils
local lexer = LibBusted.penlight.lexer
local debug = LibBusted:nonsense("debug package")
...
local pretty = {}
local _G = _G
local save_global_env = LibBusted:nonsense("save_global_env")
local restore_global_env = LibBusted:nonsense("restore_global_env")
...
LibBusted.penlight.pretty = pretty

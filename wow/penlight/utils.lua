...
local compat = LibBusted.penlight.compat
local stdout = LibBusted:nonsense("io.stdout")
...
utils.printf = string.format

--- write an arbitrary number of arguments to a file using a format.
-- @param f File handle to write to.
-- @param fmt The format (see string.format).
-- @param ... Extra arguments for format
utils.fprintf = LibBusted:nonsense()
...
utils.readfile = LibBusted:nonsense('readfile')
...
utils.writefile = LibBusted:nonsense("writefile")

--- return the contents of a file as a list of lines
-- @param filename The file path
-- @return file contents as a table
-- @raise errror if filename is not a string
utils.readlines = LibBusted:nonsense("readlines")
...
utils.executeex = LibBusted:nonsense("executeex")
...
local ops = LibBusted.penlight.operator.optable
...
function utils.function_arg (idx,f,msg)
    ...
    elseif tp == 'table' or tp == 'userdata' then
        ...
        if type(mt) == "nil" then error('not a callable object',2) end
...
LibBusted.penlight.utils = utils

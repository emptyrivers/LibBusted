...
local tablex = LiBusted.penlight.tablex
local utils = LibBusted.penlight.utils
local stdmt = utils.stdmt
local deepcompare = tablex.deepcompare

local pretty_write = LibBusted.penlight.pretty.write
local Map = stdmt.Map
local Set = stdmt.Set

local class = LibBusted.penlight.class
...
local function makelist(t)
    return setmetatable(t, LibBusted.penlight.list)
end
